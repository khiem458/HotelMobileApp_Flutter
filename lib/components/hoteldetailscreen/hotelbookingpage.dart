...
class Hotelconfirmbook extends StatefulWidget {
  const Hotelconfirmbook({super.key});
...
class _HotelconfirmbookState extends State<Hotelconfirmbook> {
  ...
  Widget build(BuildContext context) {
    BookingDto bookingDtoInfo = ModalRoute.of(context)!.settings.arguments as BookingDto;

    DateTimeRange dateRange = DateTimeRange(start: bookingDtoInfo.booking_from as DateTime, end: bookingDtoInfo.booking_to as DateTime);
    ...
    return Scaffold(
      ...
      //           .query<Listing>(r'_id == $0', [bookingDtoInfo.room_id as Object]).changes,
      ...
      body: Hotelbookformpage(bookingDtoInfo: bookingDtoInfo),
    );
  }
}
